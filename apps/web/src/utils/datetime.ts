// Ported from apps/mobile/src/utils/datetime.ts so the web log renders timestamps
// in the same YYYY/MM/DD HH:mm form the field app and the PDF use. Deliberately
// not `toLocaleString` — the format must not drift with the viewer's locale.
