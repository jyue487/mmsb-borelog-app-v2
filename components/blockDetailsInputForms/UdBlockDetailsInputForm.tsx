    ...
    <GestureHandlerRootView>
      <View style={{ paddingVertical: 20, gap: 20 }}>
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectTopDominantColourPressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectTopSecondaryColourPressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectTopDominantSoilTypePressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectTopSecondarySoilTypePressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectTopOtherPropertiesPressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row' }}>
          <Text style={{ paddingVertical: 10 }}>Base Dominant Colour<Text style={{ color: 'red' }}>*</Text>: </Text>
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectBaseDominantColourPressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row' }}>
          <Text style={{ paddingVertical: 10 }}>Base Secondary Colour: </Text>
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectBaseSecondaryColourPressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row' }}>
          <Text style={{ paddingVertical: 10 }}>Base Dominant Soil Type<Text style={{ color: 'red' }}>*</Text>: </Text>
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectBaseDominantSoilTypePressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row' }}>
          <Text style={{ paddingVertical: 10 }}>Base Secondary Soil Type: </Text>
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectBaseSecondarySoilTypePressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row' }}>
          <Text style={{ paddingVertical: 10 }}>Base Other Properties: </Text>
          <View style={{ flex: 1 }}>
            <TouchableOpacity 
              onPress={() => setIsSelectBaseOtherPropertiesPressed(prev => !prev)}
              style={{
                borderWidth: 0.5,
                alignItems: 'center',
                padding: 10,
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <TextInput
            ...
            onChangeText={(text: string) => {
              ...
              if (isNaN(penetrationDepthInMetres) || penetrationDepthInMetres <= 0) {
                return;
              }
      ...
      <Button
        ...
        onPress={() => {
          ...
          if (isNaN(parseFloat(penetrationDepthInMetresStr))) {
          ...
          if (isNaN(parseFloat(recoveryLengthInMetresStr))) {
