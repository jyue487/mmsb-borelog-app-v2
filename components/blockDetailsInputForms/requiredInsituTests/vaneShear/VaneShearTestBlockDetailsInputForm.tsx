...
export function VaneShearTestBlockDetailsInputForm({ boreholeId, inputBlock, onSubmitAsync, ...otherProps }: SpecificBlockDetailsInputFormProps) {
  ...
  return (
    <>
      ...
      <Button
        ...
        onPress={async () => {
          try {
            const newBlock: Block = checkAndReturnVaneShearTestBlock({
