export const CLAY = 'CLAY' as const;
export const SILT = 'SILT' as const;
export const PEAT = 'PEAT' as const;
export const SAND = 'SAND' as const;
export const GRAVEL = 'GRAVEL' as const;
export const CUSTOM = 'CUSTOM' as const;

export const DOMINANT_SOIL_TYPE_LIST = [CLAY, SILT, PEAT, SAND, GRAVEL, CUSTOM] as const;
...
export const SECONDARY_SOIL_TYPE_FOR_CUSTOM = [] as const;
export type SecondarySoilType = (
  ...
  | typeof SECONDARY_SOIL_TYPE_FOR_CUSTOM[number]
);
export const SECONDARY_SOIL_TYPE_LIST_BASED_ON_DOMINANT_SOIL_TYPE: Record<
  ...
  | typeof SECONDARY_SOIL_TYPE_FOR_CUSTOM
> = {
  ...
  [CUSTOM]: SECONDARY_SOIL_TYPE_FOR_CUSTOM,
} as const;
...
export const OTHER_PROPERTIES_LIST_FOR_CUSTOM = [] as const;
export const OTHER_PROPERTIES_LIST_BASED_ON_DOMINANT_SOIL_TYPE: Record<
  ...
  | typeof OTHER_PROPERTIES_LIST_FOR_CUSTOM
> = {
  ...
  [CUSTOM]: OTHER_PROPERTIES_LIST_FOR_CUSTOM,
} as const;
...
export type SecondarySoilTypeMap = {
  ...
  [CUSTOM]: typeof SECONDARY_SOIL_TYPE_FOR_CUSTOM[number];
};
...
export const CUSTOM_SOIL_CODE = 999 as const;
